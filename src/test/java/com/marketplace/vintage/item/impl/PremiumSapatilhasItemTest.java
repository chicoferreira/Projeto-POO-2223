...
public class PremiumSapatilhasItemTest {
    ...
    void getPriceCorrection() {
        ...
        PremiumSapatilhasItem premiumSapatilhasItem = new PremiumSapatilhasItem(null, null, null, basePrice, null, 0, false, "Red", collectionYear, appreciationRateOverYears);
