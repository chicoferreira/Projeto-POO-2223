...
public class ViewFactory {
    ...
    public ViewFactory(Logger logger, InputPrompter inputPrompter, UserManager userManager, ParcelCarrierManager parcelCarrierManager, ExpressionSolver expressionSolver, ItemManager itemManager, ItemFactory itemFactory) {
        this.logger = logger;
    ...
    public View createView(ViewType viewType) {
        return switch (viewType) {
            case USER -> new UserView(logger, inputPrompter, userManager, parcelCarrierManager, itemFactory, itemManager);
