...
public class VintageApplication {
    ...
    public VintageApplication() {
        ...
        VintageController vintageController = new VintageController(itemManager, itemFactory, orderManager, vintageTimeManager, parcelCarrierManager, expressionSolver);
